...
import com.aaquib.springcloud.productservice.repository.UserRepo
...
@Service
class UserDetailsServiceImpl private constructor(private val userRepo: UserRepo) : UserDetailsService {
